...
import { useStyle } from "../administrator2/BannerCss";
    ...
    <div className={classes.mainContainer}>
      <div className={classes.box}>
        <Grid container spacing={1}>
          ...
          <FormControl>
      <FormLabel id="demo-row-radio-buttons-group-label"><b style={{fontFamily:"Poppins", fontSize:20, color:"black", margin:30}}>Status</b></FormLabel>
      <RadioGroup
        row
