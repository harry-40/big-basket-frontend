                        ...
                        <Grid container spacing={2} style={{ marginTop: 5 }}>
                            ...
                            <Grid item xs={6}>
                                ...
                                <FormControl>
                                    ...
                                    >
                                        <FormControlLabel value="Available" control={<Radio />} label="Available" checked={status === 'Available'} />
                                        <FormControlLabel value="Not Available" control={<Radio />} label="Not Available" checked={status === 'Not Available'} />
